...
function IS_ENCHANT_ITEM(item)
	if item.ClassName == "Premium_Enchantchip" or item.ClassName == "Premium_Enchantchip14" or item.ClassName == "Premium_Enchantchip_CT" or
	   ...
	   or item.ClassName == "Event_Enchantchip_200" or item.ClassName == "Event_Enchantchip_8" or item.ClassName == "Event_Enchantchip_202"
       or item.ClassName == "Event_Enchantchip_10" then
		return 1;
	end
